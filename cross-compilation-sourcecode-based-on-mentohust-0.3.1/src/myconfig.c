...
static const char *CFG_FILE = "/jffs/mentohust/mentohust.conf";	/* 配置文件 */
static const char *LOG_FILE = "/jffs/mentohust/mentohust.log";	/* 日志文件 */
static const char *LOCK_FILE = "/jffs/mentohust/mentohust.pid";	/* 锁文件 */
